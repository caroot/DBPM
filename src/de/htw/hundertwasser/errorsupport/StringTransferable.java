...
public class StringTransferable implements Transferable{
	...
	{
		super();
		if (data == null) throw new IllegalArgumentException("You need to define a source.It can't be null");
		if (data.isEmpty()) throw new IllegalArgumentException("You need to define a source.It can't be emtpy");
		myData = data;
	}
	@Override
	...
	public boolean isDataFlavorSupported(DataFlavor flavor) {
		...
		{
			if (fl.equals(flavor)) return true;
		}
		return false;
	}
