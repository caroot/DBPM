...
/**
 * This Class stores PhotoBox- and PhotoAlbum List, to be referenced from
 * outside
 * 
 * @author Fabian Hewer
 * 
...
public class ElementStorage {
	 ...
	 * 
	 * @param name
	 *            The Name of the PhotoBox that is to delete
	 */
	public static void removePhotoBox(String name) {
		if (boxList == null) {
	 ...
	 *            The Name of the PhotoBox that is to delete
	 */
	public static void removePhotoBox(PhotoBox box) {
		if (boxList == null) {
			ErrorMessageDialog.showMessage(null, NO_LIST);
			return;
		}
	 ...
	 * 
	 * @param name
	 *            The Name of the PhotoAlbum that is to delete
	 */
	public static void removePhotoAlbum(String name) {
		if (albumList == null) {
			ErrorMessageDialog.showMessage(null, NO_LIST);
			return;
		}
	 ...
	 *            The Name of the PhotoAlbum that is to delete
	 */
	public static void removePhotoAlbum(PhotoAlbum album) {
		if (albumList == null) {
			ErrorMessageDialog.showMessage(null, NO_LIST);
			return;
		}
