...
public class ImageManager {
	 ...
	 * @return
	 */
	public File[] getImagesListInFolder(String path) throws IllegalArgumentException,ChoosenFileNotAFolderException,FileNotFoundException
	{
		...
		if (path.trim().isEmpty()) throw new IllegalArgumentException(ERROR_EMPTY_PATH);
			...
			if (imageList.exists())
			{
				...
				{
					throw new ChoosenFileNotAFolderException("The given path " + path + " is not a Folder.");
				}
			}
			else
			{
